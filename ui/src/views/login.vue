...
<!--                    <el-button type="text" @click="formType = 'reset'">忘记密码</el-button>-->
            ...
            <el-form v-show="formType == 'reset'" ref="resetFormRef" :model="resetForm" :rules="resetRules" class="login-form" auto-complete="on" label-position="left">
                ...
                <el-row :gutter="15" style="padding-top: 20px;">
                    <el-col :md="6">
                        <el-button size="large" style="width: 100%;" @click="formType = 'login'">{{ $t('app.goLogin') }}</el-button>
                    </el-col>
                    <el-col :md="18">
                        <el-button :loading="loading" type="primary" size="large" style="width: 100%;" @click.prevent="handleFind">{{ $t('app.check') }}</el-button>
                    </el-col>
                </el-row>
            </el-form>
        </div>
